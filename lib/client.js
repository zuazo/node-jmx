...
function Client(serviceOrHost, port, protocol, urlPath, username, password, protocolProvider) {
  var self = this;
...
Client.prototype.connect = function() {
  this.javaJmx.setCredentials(this.username, this.password,this.protocolProvider);
