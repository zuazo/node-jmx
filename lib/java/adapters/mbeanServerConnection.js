...
MBeanServerConnection.prototype.getAttribute = function(name, attribute, callback) {
  ...
  this.javaReflection.invokeMethod(this.mbeanServerConnection, method, methodParamsClass, methodParams, function(attrObject) {
...
MBeanServerConnection.prototype.getDefaultDomain = function(callback) {
  ...
  var methodParams = [];
  this.javaReflection.invokeMethod(this.mbeanServerConnection, method, methodParamsClass, methodParams, function(domain) {
    callback(domain);
  });
}
...
MBeanServerConnection.prototype.getDomains = function(callback) {
  ...
  var methodParamsClass = [];
  var methodParams = [];
  this.javaReflection.invokeMethod(this.mbeanServerConnection, method, methodParamsClass, methodParams, function(domains) {
    callback(domains);
  });
}
