...
JavaJmx.prototype.setCredentials = function(username, password, protocolProvider) {
  this.mbeanServerConnection.setCredentials(username, password, protocolProvider);
};
